...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES="v0.3.6/linux-${TARGET_ARCH}-casaos-gateway-v0.3.6.tar.gz"
    CASA_PACKAGES="${CASA_PACKAGES} v0.3.6/linux-${TARGET_ARCH}-casaos-user-service-v0.3.6.tar.gz"
    CASA_PACKAGES="${CASA_PACKAGES} v0.3.6/linux-${TARGET_ARCH}-casaos-v0.3.6.tar.gz"
    CASA_PACKAGES="${CASA_PACKAGES} v0.3.6/linux-all-casaos-v0.3.6.tar.gz"
}

# PACKAGE LIST OF CASAOS
CASA_SERVICES="casaos-gateway"
CASA_SERVICES="${CASA_SERVICES} casaos-user-service"
CASA_SERVICES="${CASA_SERVICES} casaos"
...
DownloadAndInstallCasaOS() {
    local BASE_URL="https://casaos.oss-cn-shanghai.aliyuncs.com/"
